//PANELCHECK
export const PANEL_CHECK = `/panel-check-status`;
//PANELCHECK
...
//PANEL_LOGOUT
export const PANEL_LOGOUT = `/panel-logout`;
//PANEL_SEND_PASSWORD
export const PANEL_SEND_PASSWORD = `/panel-send-password`;
...
//REGESTRATION_DATA
export const REGESTRATION_DATA = `/event-register`;
...
//MEMBER_DATA
export const GET_MEMBER_BY_ID = `/member`;
//MEMBER_DATA
